...
class ConditionalVAE(nn.Module):
    """
    Conditional VAE for L1000 perturbation signature generation.
...
def evaluate_model(model, loader):
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            pred, mu, logvar, z = model(drug, cell, num)
...
best_model_path = os.path.join(MODEL_DIR, "conditional_vae_best.pt")
